...
RUSTPACKAGES_UNINSTALL:=$(patsubst %,%-uninstall,$(RUSTPACKAGES))
PACKAGES_CLEAN+= $(RUSTPACKAGES_UNINSTALL)
...
precompiled: $(DL_DIR) $(FW_IMAGES_DIR) $(SOURCE_DIR_ROOT) $(KERNEL_TARGET_DIR) $(PACKAGES_DIR_ROOT) toolchain-depend \
	$(LIBS_PRECOMPILED) $(TARGETS_PRECOMPILED) $(PACKAGES_PRECOMPILED) $(RUSTPACKAGES)
